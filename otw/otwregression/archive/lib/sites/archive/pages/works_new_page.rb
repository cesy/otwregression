...
module Archive
  class WorksNewPage < ::Taza::Page
    ...
    #Warnings
    element(:warning) {browser.checkbox(:value, $arg1)}
    ...
    #Validation 
    element(:meta_title)  {browser.div(:id, "workskin").h2(:class, /title/)}
    element(:meta_rating) {browser.dl(:class, "work meta group").dd(:class, "rating tags")}
    element(:meta_category) {browser.dl(:class, "work meta group").dd(:class, "category tags")}       
    element(:meta_warning) {browser.dl(:class, "work meta group").dd(:class, "warning tags")}
    element(:meta_fandom) {browser.dl(:class, "work meta group").dd(:class, "fandom tags")}
    element(:meta_pairing) {browser.dl(:class, "work meta group").dd(:class, "relationship tags")}
    element(:meta_char) {browser.dl(:class, "work meta group").dd(:class, "character tags")}
    element(:meta_freeform) {browser.dl(:class, "work meta group").dd(:class, "freeform tags")}
    element(:meta_stats) {browser.dl(:class, "work meta group").dd(:class, "stats")}
