...
Then /^Tags should be "([^"]*)"$/ do |arg1|
  @site.works_new_page.meta_freeform.include?(arg1)
end
...
Then /^Fandom should be "([^"]*)"$/ do |arg1|
  @site.works_new_page.meta_fandom.include?(arg1)
end

Then /^Warning should be "([^"]*)"$/ do |arg1|
  @site.works_new_page.meta_warning(arg1)
end
...
Then /^Category should be "([^"]*)"$/ do |arg1|
  @site.works_new_page.meta_category.include?(arg1)
end

Then /^Pairing should be "([^"]*)"$/ do |arg1|
  @site.works_new_page.meta_pairing.include?(arg1)
end

Then /^Character whould be "([^"]*)"$/ do |arg1|
  @site.works_new_page.meta_char.include?(arg1)
end

Then /^Fandoms should be "([^"]*)"$/ do |arg1|
    @site.works_new_page.meta_rating.include?(arg1) 
end

Then /^Work Title should be "([^"]*)"$/ do |arg1|
  @site.works_new_page.meta_title.include?(arg1)
end
...
Then /^Notes should contain Inspired by Title by Author$/ do
  @site.works_new_page.post_notes.text.include?("Aerial") #TODO: Make Generic
  @site.works_new_page.post_notes.text.include?("astolat") #TODO: Make Generic
end

Then /^I fill in the url with the archive work$/ do
  @site.works_new_page.remix_url_field.set("http://testarchive.transformativeworks.org/works/164450") #TODO: Generic
end
...
Then /^I check translation$/ do
  @site.works_new_page.remix_translation.set
end
...
Then /^I check Notes$/ do
  @site.works_new_page.notes_show.set
end

Then /^I check End Notes$/ do
  @site.works_new_page.endnotes_show.set
end
